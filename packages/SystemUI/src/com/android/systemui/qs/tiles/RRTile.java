...
/** Quick settings tile: RR Configurations **/
public class RRTile extends QSTile<QSTile.BooleanState> {
	private static final String CATEGORY_RR_TOOLS = "com.android.settings.Settings$MainSettings";
    ...
    protected void handleClick() {
        ...
        intent.addCategory(CATEGORY_RR_TOOLS);
